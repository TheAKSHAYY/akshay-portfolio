...
const PROJECTS = [
  {
    ...
    statusType: 'live',
    tagline: 'Production-grade course hierarchy & student learning ecosystem.',
    description:
      'A full-stack learning platform engineered around dynamic course management, admin CMS tooling, role-based authorization, and student portals. Shipped to production on Vercel with high-availability cloud architecture.',
    highlights: [
  ...
  },
  {
    ...
    title: 'WAVELENGTH',
    category: 'BROWSER AUDIO ENGINE',
    status: 'LIVE EXPERIMENT',
    statusType: 'live',
    tagline: 'Real-time audio frequency analysis and reactive waveform canvas.',
    description:
      'An interactive browser experiment that interfaces with the Web Audio API to capture microphone input or uploaded tracks, performing Fast Fourier Transform (FFT) frequency analysis to render synchronized audio waveforms at 60 FPS.',
    highlights: [
      'Real-time FFT audio buffer sampling via Web Audio AnalyserNode',
      'Hardware-accelerated HTML5 Canvas 60 FPS waveform visualization',
